...
use App\Http\Controllers\{BoardController, BoardUserController, TaskController, CommentController};
...
Route::get('/boards/{board}/tasks/{task}/comments/create', [CommentController::class, 'create'])->middleware('auth')->name('comments.create');
Route::post('/boards/{board}/tasks/{task}/comments', [CommentController::class, 'store'])->middleware('auth')->name('comments.store');